...
// @Success 201 {object} model.Success201Response
...
// @Failure 400 {object} model.Response
// @Failure 401 {object} model.Error401Response
// @Failure 500 {object} model.Response
// @Router /login [post]
...
// @Description Mengubah password user yang sedang login berdasarkan token JWT. Endpoint ini membutuhkan token Bearer dari hasil login.
// @Tags Auth
// @Security BearerAuth
// @Accept json
// @Produce json
// @Param request body model.ChangePasswordRequest true "Payload ubah password"
// @Success 200 {object} model.Success200Response
// @Failure 400 {object} model.Response
// @Failure 401 {object} model.Error401Response
...
func ChangePassword(c *fiber.Ctx) error {
	...
	return c.JSON(model.Success200Response{
