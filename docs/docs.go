            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/model.Success200Response"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
                        "schema": {
                            "$ref": "#/definitions/model.Error401Response"
                        }
                    },
                    "500": {
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/model.Success201Response"
                        }
                    },
                    "400": {
                    ...
                    "403": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/model.Error403Response"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
